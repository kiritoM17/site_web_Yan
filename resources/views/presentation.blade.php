...
@section('content-page')
    <div class="row" style="margin-bottom:0px !important">
        <div class="col-lg-4 col-md-12">
            <center><img class="thumbnail" src="{{ url('img/logo.jpg') }}" width="300" heigth="300"></center>
            </div>
            <div class="col-lg-8 col-md-8 actu-div">
                <div class="row visible-sm">
                    <div class="col-md-12 col-lg-12" style="float: none">
                        <h3>AMAFOR PRESENTATION</h3>
                    </div>
                </div>
                <div class="row">
    ...
    <div class="row actu-div" style="margin-top:0px !important;">
        <ul>
