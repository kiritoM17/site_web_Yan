                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Bonjour {{$contact['noms']}},</span>
                                    </font>
                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">Nous Avons été notifier du don que vous aimeriez faire à notre association, Le service en ligne étant indisponible pour l'instant, nous mettons à votre disposition nos Informations du relevé d'identité bancaire (RIB) pour que vous puissez nous faire un virement Bancaire<br> code banque:  <b>10001</b><br>Code guichet:  <b>06861</b><br> Numéro de compte: <b>61794561002</b><br> CLE : <b>09</b><br>Code IBAN:<b>CM21 1000106861 61794561002 09</b><br>Adresse SWIF(BIC): <b>ICLRCMCXXXX</b></span> </span>
                                    </font>
                                    <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;"><br>Nous vous invitons à nous contacter pour plus d'information<br> Cordialement JADD</span>
                                    </font>
                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
