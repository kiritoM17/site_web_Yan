<div class="row clearfix">
                        ...
                        <div class="post-content">
                            <div class="category">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li data-toggle="modal" data-target="#addRegister{{$pub->id_pub}}"><a href="javascript:void(0);"><span class="hidden-xs">Add FORM</span><i class="material-icons" style="color: orangered !important" >add_a_photo</i></a></li>
                                    <li data-toggle="modal" data-target="#addSyllabus{{$pub->id_pub}}"><a href="javascript:void(0);"><span class="hidden-xs">SYLLABUS</span><i class="material-icons" style="color: orangered !important" >add_a_photo</i></a></li>
    ...
    @include('adminView.layouts.publication.partials.updateFormation')
    @include('adminView.layouts.publication.partials.addMedia')
    @include('adminView.layouts.publication.partials.deletePublication')
    @include('adminView.layouts.publication.partials.addRegisterForm')
    @include('adminView.layouts.publication.partials.addSylabuss')
    @endforeach
    {{ $formation->links() }}
    @endif
</div>