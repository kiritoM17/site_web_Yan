<section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="adminTools/bsbmd/images/user.png" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="email"><a href="{{url('admin/logout')}}" class="btn btn-sm btn-primary">Se déconnecter</a></div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li {{Route::is('partenaire')? 'class=active':''}}>
