<div class="row clearfix">
                            ...
                            <div class="post-content">
                                <div class="category">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li data-toggle="modal" data-target="#addImage{{$pub->id_pub}}"><a href="javascript:void(0);"><span class="hidden-xs">Add Images</span><i class="material-icons" style="color: orangered !important" >add_a_photo</i></a></li>
    ...
    {{ $magazine->links() }}
    @else
            <center>Can't find Magazine record</center>
    @endif
</div>